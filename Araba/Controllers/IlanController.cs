...
namespace Araba.Controllers
{
    public class IlanController : Controller
    {
        ...
        {
            string path = Path.Combine("/Content/Resimler/" + file.FileName);
        ...
        public ActionResult Create([Bind(Include = "IlanId,IlanNo,Aciklama,Fiyat,Tarih,Kilometre,ModelYili,YakitTuru,VitesTuru,Telefon,DurumId,MarkaId,ModelId,SehirId")] Ilan ilan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IlanId,IlanNo,Aciklama,Fiyat,Tarih,Kilometre,ModelYili,YakitTuru,VitesTuru,Telefon,DurumId,MarkaId,ModelId,SehirId")] Ilan ilan)
        {
            if (ModelState.IsValid)
            {
